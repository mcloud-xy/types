...
func (in *Client) DeepCopyInto(out *Client) {
	*out = *in
	...
	if in.horizontalPodAutoscalerControllers != nil {
		in, out := &in.horizontalPodAutoscalerControllers, &out.horizontalPodAutoscalerControllers
		*out = make(map[string]HorizontalPodAutoscalerController, len(*in))
		for key, val := range *in {
			if val == nil {
				(*out)[key] = nil
			} else {
				(*out)[key] = val.DeepCopyHorizontalPodAutoscalerController()
			}
		}
	}
	return
