...
func (in *Client) DeepCopyInto(out *Client) {
	*out = *in
	...
	if in.storageClassControllers != nil {
		in, out := &in.storageClassControllers, &out.storageClassControllers
		*out = make(map[string]StorageClassController, len(*in))
		for key, val := range *in {
			if val == nil {
				(*out)[key] = nil
			} else {
				(*out)[key] = val.DeepCopyStorageClassController()
			}
		}
	}
	return
