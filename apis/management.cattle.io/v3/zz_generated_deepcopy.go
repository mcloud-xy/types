...
func (in *ClusterAlertRuleSpec) DeepCopyInto(out *ClusterAlertRuleSpec) {
	*out = *in
	...
	if in.DeploymentRule != nil {
		in, out := &in.DeploymentRule, &out.DeploymentRule
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricRuleV2) DeepCopyInto(out *MetricRuleV2) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricRuleV2.
func (in *MetricRuleV2) DeepCopy() *MetricRuleV2 {
	if in == nil {
		return nil
	}
	out := new(MetricRuleV2)
